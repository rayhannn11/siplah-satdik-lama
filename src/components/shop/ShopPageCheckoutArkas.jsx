...
const ShopPageCheckoutArkas = (props) => {
    const [state, dispatch] = useReducer(reducer, initialState, init);
    const { customer, addMiniCart } = props;
    const { id } = useParams();
    console.log(`ids , pra`, id);
    const [data, setData] = useState({});
    const [note, setNote] = useState(""),
        [sendRequest, setSendRequest] = useState(false);
    const id_local = localStorage.getItem("idCheckOut");
    ...
    useEffect(() => {
        ...
        if (prMatch && prMatch[1]) {
            console.log("PR value:", prMatch[1]);
            setNote(prMatch[1]);
            // Set the PR value to state or use it as needed
        }
    }, []);
                    ...
                    <div className="d-flex mt-2">
                        ...
                        >
                            ...
                            <img
                                ...
                                src="https://storage.googleapis.com/go-merchant-production.appspot.com/uploads/2020/09/0fcddd245474380834dfe5f3beb0492f_093eb297aba2188382cf91e556dd9bdf_compressed.png"
                                style={{ height: 25 }}
                            ></img>{" "}
                            <br /> BRIVA BRI
                        </small>
                ...
                <div className="card p-2 idBPD">
                    <div className="d-flex mt-2">
                        <small
                            ...
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD JATENG" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                        ...
                        <small
                            ...
                            style={{ width: "50%", height: 60, marginRight: 10, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD NAGARI" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                ...
                <div className="card p-2 idBPD">
                    <div className="d-flex mt-2">
                        <small
                            ...
                            style={{ width: "50%", height: 60, marginRight: 10, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD KALSEL" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                        ...
                        <small
                            ...
                            style={{ width: "50%", height: 60, marginRight: 10, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD LAMPUNG" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
        ...
        <Modal isOpen={openPeringatan} toggle={() => setOpenPeringatan(!openPeringatan)}>
            <ModalBody>
                ...
                <div class="text-left p-3" style={{ color: "#0e336d" }}>
                    {" "}
                    <h5>Anda akan menuju halaman Perencanaan Pembelanjaan</h5>{" "}
                </div>
                <div class="text-left p-3" style={{ color: "#000" }}>
                    <p>
                        Di halaman Perencanaan Pembelanjaan, Anda dapat memilih sumber dana untuk pesanan ini & wajib
    ...
    function doCreateOrderArkas() {
        ...
        setSendRequest(true);
        req = { ...req, note, shipping: state.checkout.shippingTerpilih, id, from: fromLocalStorage };
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <div style="text-align: center;">
                                <p><strong>Maaf, transaksi tidak dapat diproses.</strong></p>
                                <p>${result.status.message}</p>
                                <p>Silakan kembali ke halaman keranjang untuk melanjutkan.</p>
                            </div>
                        `,
    ...
    console.log("lala");
    console.log(state?.checkout?.from, "from");
    ...
    if (state.checkout == null) {
        ...
        console.log(state.checkout, "test");
        ...
        if (adaStokKosong) {
            ...
            Swal.fire({
                html: `Pemetaan Arkas Sudah berhasil`,
                title: "Info",
                allowOutsideClick: false,
                icon: "success",
            ...
            // run()
            // props.history.push("/shop/cart");
            //   alert("Telah dibuat Draft Pesanan")
        }
                        ...
                        <div className="col-lg-6 mb-2">
                            ...
                            <div class="card">
                                <div class="card-body row justify-content-center align-items-center">
                                    ...
                                    <div className="col-lg-6">
                                        <h6 className="pt-sm-2" onClick={() => setOpenVa(!openVa)}>
                                            Metode Pembayaran
                                        </h6>
                                    </div>
                                    <div className="col-lg-6">
