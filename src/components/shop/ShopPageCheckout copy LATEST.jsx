...
const ShopPageCheckout = (props) => {
    ...
    const [paymentMethodName, setPaymentMethodName] = useState("bank_bri_va");
        ...
        <Modal isOpen={openVa} centered toggle={() => setOpenVa(!openVa)}>
            <ModalBody>
                <div class="text-center p-3" style={{ color: "#0e336d" }}>
                    {" "}
                    <h5>Metode Pembayaran SIPLah Eureka123</h5>{" "}
                </div>
                ...
                <div className="card p-2 idBPD">
                    <div className="d-flex mt-2">
                        ...
                        <small
                            ...
                            style={{ width: "50%", height: 60, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD SUMUT" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                ...
                <div className="card p-2 idBPD">
                    <div className="d-flex mt-2">
                        <small
                            ...
                            style={{ width: "50%", height: 60, marginRight: 10, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD JAMBI" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                                alt="logo siplah eureka"
                                src="https://bankjambi.co.id/assets/img/logohead.png"
                                style={{ height: 25 }}
                            ></img>{" "}
                            <br /> BANK JAMBI
                        </small>
                        <small
                            ...
                            style={{ width: "50%", height: 60, marginRight: 10, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD NTB SYARIAH" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                        ...
                        <small
                            ...
                            style={{ width: "50%", height: 60, fontSize: 14 }}
                            onClick={(val) =>
                                doHandleChangeSelect({ value: "bank_bpd_va", name: "BPD KALBAR" }, "paymentMethod")
                            }
                        >
                            {" "}
                            <img
                                alt="logo siplah eureka"
                                src="https://asbanda.org/upload/blog_asbanda_20191109022442.jpg"
                                style={{ height: 25 }}
                            ></img>{" "}
                            <br /> BANK KALBAR
                        </small>
