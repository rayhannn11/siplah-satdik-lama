...
const ShopPageCheckout = (props) => {
    ...
    const waitPayment = (
        <Modal isOpen={openVa} centered toggle={() => setOpenVa(!openVa)}>
            <ModalBody>
                <div class="text-center p-3" style={{color:'#0e336d'}}>  <h5 >Metode Pembayaran SIPLah Eureka</h5> </div>
                ...
                <div className="card p-2 idVA">
                    <div className="d-flex mt-2">
                        ...
                        {/* <small className="border p-2 text-center btn btn-default" style={{width:"50%", height: 60, marginRight:10, fontSize:14 }}> </small> 
                        <small className="border p-2 text-center btn btn-default" style={{width:"50%", height: 60, fontSize:14 }}> </small>  */}
    ...
    const waitPeringatan = (
        <Modal isOpen={openPeringatan} centered toggle={() => setOpenPeringatan(!openPeringatan)}>
            <ModalBody>
                <div class="text-center p-3" style={{color:'#0e336d'}}>  <h5 >Pelaksana dalam kapasitas mewakili  Satuan Pendidikan menyatakan bahwa pesanan telah sesuai dengan:</h5> </div>
                ...
                <p><a href="https://docs.google.com/document/d/18mVqLwLYZTLj1Hxrtx10G_BKaQVQhuBFlxDST-VuRBA/edit" target="_blank"> <b><u>Link Peraturan</u></b></a> </p>  
                <p style={{marginLeft:30, color:'red'}}>
                 <input type="checkbox" onClick={e =>setCekList(!cekList)} class="form-check-input" checked={cekList}  />
                 <b>Satdik wajib checklist pesan peringatan sebelum order ID ke generate. (Ceklist untuk melanjutkan)</b>
                </p>
                { cekList === true ?
    ...
    const waitPeraturan = (
        <Modal isOpen={openPeraturan} centered toggle={() => setOpenPeraturan(!openPeraturan)}>
            <ModalBody>
                <div class="text-center p-3" style={{color:'#0e336d'}}>  <h5 >Peraturan SIPLAH:</h5> </div>
                <div class="text-left p-3" style={{color:'#0e336d'}}>
                <p>1. Ketentuan PBJ Satuan Pendidikan sesuai Permendikbudristek 18 Tahun 2022 pasal 23 untuk memastikan barang/jasa memenuhi kriteria yang berlaku. </p>
                <p>2. Ketentuan pengadaan barang jasa yang dapat berlaku dalam wilayah Satuan Pendidikan terkait</p>
                <p>{"3. Jika berbelanja dengan sumber dana bantuan sarana/prasarana dalam bentuk uang, mengikuti ketentuan maksimal nominal belanja yang berlaku sesuai dengan Peraturan Menteri Keuangan No. 168/PMK.05/2015 Pasal 24 & 25."}</p>
                <p style={{marginLeft:30, color:'red'}}>
                 <input type="checkbox" onClick={e =>setCekList(!cekList)} class="form-check-input" checked={cekList}  />
                 <b>Satdik wajib checklist pesan peringatan sebelum order ID ke generate. (Ceklist untuk melanjutkan)</b>
                </p>
                                ...
                                <div class="card-body row justify-content-center align-items-center">
                                    ...
                                    <div className="col-lg-6">
                                        <div class="form-group "> 
                                            <input   class="form-control" placeholder="Pilih Metode Pembayaran" value={paymentMethodName}    onClick={() => setOpenVa(!openVa)} readOnly/>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                                            ...
                                                            isCreateOrder() && !customer.position.toLowerCase().includes("bendahara") ?
                                                                ...
                                                                { countValid > 3 ?
                                                                    <button
                                                                        type="button"
                                                                        // onClick={run}
                                                                        onClick={() => setOpenPeringatan(!openPeringatan)}
                                                                        title="Buat Pesanan"
                                                                        disabled={loading}
                                                                        className={classNames(
                                                                            "btn btn-primary custome btn-md btn-block cart__checkout-button",
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        style={{borderRadius: '5px',  color: 'white', marginTop: '10px', marginBottom: '10px', background: '#828282'}} 
                                                                    >
                                                                        Buat Pesanan Baru
                                                                    </button>
                                                                    </>
                                                                ...
                                                                <div class="alert alert-secondary mt-2" role="alert"> 
                                                                        <h5 class="alert-heading">Anda tidak memiliki akses untuk membuat pesanan</h5>
                                                                        <p>
                                                                        Silakan hubungi Kepala Sekolah atau pelaksana pengadaan barang/jasa yang ditugaskan untuk dapat membuat pesanan. 
                                                                        </p> 
                                                                    </div>
                                                                </>
                                                            } 
