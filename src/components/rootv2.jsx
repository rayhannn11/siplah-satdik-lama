...
const Root = (props) => {
    ...
    console.log(props?.customer?.token, "dari root");

    // useEffect(() => {
    //     const token = props?.customer?.token;
    //     console.log(token, "token root");
    //     if (!token) {
    //         console.log("Belum login, skip token check");
    //         return;
    //     }

    //     const checkToken = async () => {
    //         try {
    //             const res = await fetch(https://siplah.eurekabookhouse.co.id/api/cart?limit=3&page=1, {
    //                 method: "GET",
    //                 headers: {
