    ...
    const handlePreviewClick = async () => {
        try {
            ...
            try {
                ...
                doHandlePreviewEbast(ebastContent, filesGoodCondition, file, fine.floatValue, longDelay);
                ...
                <div class="card-body">
                    ...
                    {!isEbastCetak && (
                        <div className="form-group">
                            <label htmlFor="upload-barang">Upload foto barangs</label>
                            <input
                                id="upload-barang"
                                type="file"
                                ...
                                onChange={(e) => {
                                    ...
                                    setFilesGoodCondition(Array.from(e.target.files));
                                }}
                                multiple
                                accept="image/*"
                            />
                            ...
                            <small className="d-block mt-1">
                                <span className="text-danger">*</span>{" "}
                                <b>Tekan CTRL + pilih foto untuk lebih dari 1 foto</b>
                            </small>
