...
const ModalEbast = (props) => {
    ...
    // Add new state for Proses Penerusan Dana modal
    const [openPenerusanDana, setOpenPenerusanDana] = useState(false);
    const [checkedPenerusanDana, setCheckedPenerusanDana] = useState(false);
    ...
    // Add validation function to check if all quantities are complete
    const isAllQuantitiesComplete = () => {
        return ebastContent.every((item) => {
            const originalItem = items.find((originalItem) => originalItem.orderProductId === item.orderProductId);
            ...
            return totalQty === originalQty;
        });
    };

    // Add validation function to check if individual item quantity is incomplete
    const isItemQuantityIncomplete = (item) => {
        const originalItem = items.find((originalItem) => originalItem.orderProductId === item.orderProductId);
        if (!originalItem) return false;
        ...
        // Return true if quantities are not zero but incomplete
        return totalQty > 0 && totalQty < originalQty;
    };

    // Check if preview button should be disabled
    const isPreviewDisabled = () => {
        return loadingBaseQty || isAllQuantitiesZero() || !isAllQuantitiesComplete();
    };
    ...
    const handlePreviewClick = async () => {
        try {
            ...
            // Validasi BAST sebelum melanjutkan
            if (validasiBast === false) {
                setIsLoading(false);
                await Swal.fire({
                        ...
                        <table class="table table-responsive text-center">
                            ...
                            <tbody style={{ maxHeight: "50vh", overflow: "auto" }}>
                                {items.map((item, index) => {
                                    ...
                                    const ebastItem = findObjectInEbastContent(item);
                                    const isIncomplete = isItemQuantityIncomplete(ebastItem);
                                    return (
                                        <tr
                                            className={isIncomplete ? "table-danger" : ""}
                                            style={isIncomplete ? { backgroundColor: "#f8d7da" } : {}}
                                        >
                                            <td>{++index}</td>
                                            <td>
                                                <p
                                                    ...
                                                    if (
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                // Check if we need to show Proses Penerusan Dana modal
                                                                if (
                                                                    isEbastCetak === false &&
                                                                    paymentMethodSelected.value === "bank_himbara"
                                                                ) {
                                                                    setOpenPenerusanDana(true);
                                                                } else {
                                                                    doHandleProcessToPayment();
                                                                }
                                                            }
        ...
        <>
            <div class="card">
                <div class="card-body">
                    ...
                    {/* Warning for incomplete quantities */}
                    {!isAllQuantitiesComplete() && !isAllQuantitiesZero() && (
                        <div className="alert alert-danger" role="alert">
                            <i className="fas fa-exclamation-triangle mr-2"></i>
                            <strong>Perhatian!</strong> Beberapa barang memiliki jumlah penerimaan yang tidak lengkap
                            (ditandai dengan latar belakang merah). Pastikan jumlah qty baik + qty buruk sama dengan qty
                            pesanan sebelum melanjutkan preview.
                        </div>
                    )}
                                                ...
                                                <div className="form-group" style={{ width: "90px" }}>
                                                    ...
                                                    {findObjectInEbastContent(item).amountGoodError && (
                                                        <div class="invalid-feedback">
                                                            Jumlah barang telah sesuai.
                                                            <br /> kurangi jumlah{" "}
                                                            <span className="font-weight-bold">barang buruk</span> agar
                                                ...
                                                <div className="form-group" style={{ width: "90px" }}>
                                                    ...
                                                    {findObjectInEbastContent(item).amountBadError && (
                                                        <div class="invalid-feedback">
                                                            Jumlah barang telah sesuai.
                                                            <br /> kurangi jumlah{" "}
                                                            <span className="font-weight-bold">barang baik</span> agar
                                                            bisa menambah jumlah{" "}
                                                            <span className="font-weight-bold"> barang buruk</span>.
                                                        </div>
                                                    )}
                        ...
                        <div class="form-group">
                            ...
                            <div
                                ...
                                onDrop={(e) => {
                                    ...
                                    for (let i = 0; i < files.length; i++) {
                                        ...
                                        console.log(
                                            `File type: ${typeof file}, instanceof File: ${file instanceof File}`
                                        );
                            ...
                            >
                                <i
                                    ...
                                    style={{ fontSize: "2rem", color: "#007bff", marginBottom: "10px" }}
                                ></i>
                                <div>
                                                        ...
                                                        <div className="card">
                                                            ...
                                                            >
                                                                <img
                                                                    ...
                                                                    onError={() => {
                                                                        console.error(
                                                                            `Error loading image for file ${index}`
                                                                        );
                                                                        URL.revokeObjectURL(previewUrl);
                                                                    }}
                                                                />
                                                                <button
                                                                    ...
                                                                    onClick={() => {
                                                                        const updatedFiles = filesGoodCondition.filter(
                                                                            (_, i) => i !== index
                                                                        );
                    ...
                    {isPreviewEbast === true && (
                        <button
                            ...
                            title={
                                isAllQuantitiesZero()
                                    ? "Harap isi qty terima baik atau buruk terlebih dahulu"
                                    : !isAllQuantitiesComplete()
                                    ? "Jumlah qty baik + qty buruk harus sama dengan qty pesanan"
                                    : ""
                            }
                        >
                            {loadingBaseQty
            ...
            {/* Modal Proses Penerusan Dana */}
            <Modal
                isOpen={openPenerusanDana}
                centered
                toggle={() => setOpenPenerusanDana(!openPenerusanDana)}
                style={{ maxWidth: 600 }}
            >
                <div className="modal-header">
                    <h5 className="modal-title">
                        <i className="fas fa-money-check-alt mr-2 text-primary"></i>
                        Proses Penerusan Dana Himbara
                    </h5>
                    <button type="button" className="close" onClick={() => setOpenPenerusanDana(false)}>
                        <span>&times;</span>
                    </button>
                </div>
                <ModalBody>
                    <div className="alert alert-info">
                        ...
                        <strong>Informasi:</strong> Proses penerusan dana ke mitra akan dilakukan setelah BAST selesai
                        dibuat.
                    </div>
                    ...
                    <div className="card border-0 bg-light">
                        <div className="card-body">
                            <h6 className="card-title text-primary">
                                ...
                                Konfirmasi Penerusan Dana
                            </h6>
                            <p className="card-text">Dengan mencentang kotak di bawah ini, Anda menyetujui bahwa:</p>
                            <ul className="list-unstyled ml-3">
                                <li>
                                    <i className="fas fa-check text-success mr-2"></i>Dana akan diteruskan ke mitra
                                    sesuai dengan ketentuan
                                </li>
                                <li>
                                    <i className="fas fa-check text-success mr-2"></i>BAST yang telah dibuat tidak dapat
                                    dibatalkan
                                </li>
                                <li>
                                    <i className="fas fa-check text-success mr-2"></i>Proses pembayaran akan dilanjutkan
                                    sesuai prosedur
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="form-check mt-4 border rounded bg-light">
                        <input
                            className="form-check-input"
                            type="checkbox"
                            id="checkPenerusanDana"
                            checked={checkedPenerusanDana}
                            onChange={(e) => setCheckedPenerusanDana(e.target.checked)}
                        />
                        <label className="form-check-label font-weight-bold text-primary" htmlFor="checkPenerusanDana">
                            {/* <i className="fas fa-shield-alt mr-2"></i> */}
                            Saya menyetujui proses penerusan dana ke mitra dan memahami bahwa BAST yang telah dibuat
                            bersifat final.
                        </label>
                    </div>
                </ModalBody>
                <div className="modal-footer">
                    <button type="button" className="btn btn-secondary" onClick={() => setOpenPenerusanDana(false)}>
                    ...
                    <button
                        ...
                        className={classNames("btn btn-primary", {
                            disabled: !checkedPenerusanDana,
                        })}
                        disabled={!checkedPenerusanDana}
                        onClick={() => {
                            if (checkedPenerusanDana) {
                                setOpenPenerusanDana(false);
                                setCheckedPenerusanDana(false); // Reset checkbox for next time
                                doHandleProcessToPayment();
                            }
                        }}
                    >
                        <i className="fas fa-check-circle mr-2"></i>
                        Lanjut Selesaikan BAST
                    </button>
                </div>
            </Modal>
        </>
