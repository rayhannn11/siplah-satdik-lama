...
function AccountPageOrderDetails(props) {
    ...
    const doHandleSendEbast = (req, filesGoodCondition, filesBadCondition, penaltyPrice, penaltyDay) => {
        return new Promise((resolve) => {
            ...
            if (
                ...
                toast.error("Upload minimal 1 foto barang dalam kondisi baik");
                return resolve();
            }
    ...
    const doHandlePreviewEbast = (req, filesGoodCondition, filesBadCondition, penaltyPrice, penaltyDay) => {
        return new Promise((resolve) => {
            ...
            {
                toast.error("Upload minimal 1 foto barang dalam kondisi terima dengan baik");
                return resolve();
            }
            customerApi.sendEbast(formData, token).then((res) => {
                const { code, message } = res.status;
            ...
            <>
                ...
                <div className="row"  >
                    <div className="col-12">    
                        {
                        openEdit === false ?
                        items?.map(item => item.isApplyChange).reduce((a, b) => a || b) && (
                            <div className="mt-2">
                            <button
                ...
                <div className="row mt-3 no-gutters mx-n2">
                        ...
                        <div className="card address-card address-card--featured mt-2">
                            <div className="address-card__body">
                                ...
                                <div className="row justify-content-between align-items-center mt-2"> 
                                    ...
                                    {isFormBatal && (
                                        <div className="col-12 mt-2"> 
                                            <label>Upload Form Pembatalan</label>
                                            <div class="custom-file">
                                                <input
                                                    type="file"
                                                    class="custom-file-input"
                    ...
                    {!status.name.toLowerCase().includes("pesanan dibekukan") && (
                        <>
                            {isApplyCancel && (
                                <div className="col-md-6 px-2 mt-2">
                                    <button className="btn btn-block btn-danger" onClick={doHandleCancellationProposed}>
                                        Batalkan Pesanan
                                    </button>
                                </div>
                            )}
                ...
                <Modal isOpen={modal['reason']} centered toggle={() => doOpen("reason")} class="modal"> 
                    ...
                    <ModalBody>
                        ...
                        <div className='d-flex justify-content-end w-100'> 
                            <button type="button" class="btn btn-danger" onClick={() => doOpen("reason")} style={{marginRight:10}} >Batal</button>
                            <button type="button" class="btn btn-primary" onClick={() => doHandleCancelOrder(id)}>Kirim</button>
                        </div>
                    </ModalBody>
                </Modal>
...
export default connect(mapStateToProps, null)(AccountPageOrderDetails);
